//
// Generated file, do not edit! Created by nedtool 5.6 from plexe/messages/PlatooningBeacon.msg.
//
...
int PlatooningBeaconDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "controllerAcceleration")==0) return base+1;
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "speedX")==0) return base+9;
    if (fieldName[0]=='s' && strcmp(fieldName, "speedY")==0) return base+10;
    if (fieldName[0]=='a' && strcmp(fieldName, "angle")==0) return base+11;
...
std::string PlatooningBeaconDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return double2string(pp->getControllerAcceleration());
        ...
        case 9: return double2string(pp->getSpeedX());
        case 10: return double2string(pp->getSpeedY());
        case 11: return double2string(pp->getAngle());
        default: return "";
    }
}
...
bool PlatooningBeaconDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setControllerAcceleration(string2double(value)); return true;
        ...
        case 9: pp->setSpeedX(string2double(value)); return true;
        case 10: pp->setSpeedY(string2double(value)); return true;
        case 11: pp->setAngle(string2double(value)); return true;
