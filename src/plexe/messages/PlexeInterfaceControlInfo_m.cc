...
PlexeInterfaceControlInfoDescriptor::PlexeInterfaceControlInfoDescriptor() : omnetpp::cClassDescriptor("PlexeInterfaceControlInfo", "omnetpp::cMessage")
{
...
int PlexeInterfaceControlInfoDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "interfaces")==0) return base+0;
...
int PlexeInterfaceControlInfoDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PlexeInterfaceControlInfo *pp = (PlexeInterfaceControlInfo *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *PlexeInterfaceControlInfoDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string PlexeInterfaceControlInfoDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PlexeInterfaceControlInfo *pp = (PlexeInterfaceControlInfo *)object; (void)pp;
    switch (field) {
        case 0: return enum2string(pp->getInterfaces(), "plexe::PlexeRadioInterfaces");
        default: return "";
    }
}

bool PlexeInterfaceControlInfoDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PlexeInterfaceControlInfo *pp = (PlexeInterfaceControlInfo *)object; (void)pp;
    switch (field) {
        case 0: pp->setInterfaces((plexe::PlexeRadioInterfaces)string2enum(value, "plexe::PlexeRadioInterfaces")); return true;
...
void *PlexeInterfaceControlInfoDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
