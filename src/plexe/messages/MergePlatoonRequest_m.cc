...
void MergePlatoonRequest::setMembersArraySize(unsigned int size)
{
    int *members2 = (size==0) ? nullptr : new int[size];
...
unsigned int MergePlatoonRequest::getMembersArraySize() const
{
    return members_arraysize;
}

int MergePlatoonRequest::getMembers(unsigned int k) const
{
    if (k>=members_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", members_arraysize, k);
    return this->members[k];
}

void MergePlatoonRequest::setMembers(unsigned int k, int members)
{
    if (k>=members_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", members_arraysize, k);
...
MergePlatoonRequestDescriptor::MergePlatoonRequestDescriptor() : omnetpp::cClassDescriptor("MergePlatoonRequest", "JoinPlatoonRequest")
{
...
int MergePlatoonRequestDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MergePlatoonRequest *pp = (MergePlatoonRequest *)object; (void)pp;
    switch (field) {
...
const char *MergePlatoonRequestDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string MergePlatoonRequestDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MergePlatoonRequest *pp = (MergePlatoonRequest *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getMembers(i));
        default: return "";
    }
}

bool MergePlatoonRequestDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MergePlatoonRequest *pp = (MergePlatoonRequest *)object; (void)pp;
    switch (field) {
        case 0: pp->setMembers(i,string2long(value)); return true;
...
void *MergePlatoonRequestDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
