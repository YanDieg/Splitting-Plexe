...
#ifndef SPLITTINGMANEUVERSCENARIO_H_
#define SPLITTINGMANEUVERSCENARIO_H_
...
class SplittingManeuverScenario : public BaseScenario {

protected:
    // message used to start the maneuver
    cMessage* startManeuver;
    // pointer to protocol
    SplittingPlatooningApp* app;
public:
...
public:
    SplittingManeuverScenario()
    {
        startManeuver = nullptr;
        app = nullptr;
    }
    virtual ~SplittingManeuverScenario();
